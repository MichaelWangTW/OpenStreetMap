...
public class TestDirections {
    ...
    public void testRouteDirections() throws Exception {
        ...
        for (int i = 0; i < NUM_TESTS; i++) {
            ...
            List<Long> path1 = new LinkedList<>();
            path1.add(4235206812L);
            path1.add(53130811L);
            path1.add(4235206807L);
            path1.add(53043845L);
            path1.add(283261510L);
            path1.add(4235206800L);
            path1.add(283261515L);
            path1.add(4168260357L);
            path1.add(283261516L);
            path1.add(4235205784L);
            path1.add(2322645922L);
            path1.add(53046610L);
            path1.add(53092794L);
            path1.add(53052373L);
            path1.add(2820207938L);
            path1.add(53052374L);

            List<Router.NavigationDirection> my = Router.routeDirections(graph, path1);
